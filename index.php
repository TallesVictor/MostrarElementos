...
<form method="post" action="#" name="form1">
    ...
    <tr>
        <td >
            ...
            <button type="button" class="btn btn-outline-dark btn-sm somar"onclick="mais( 'quantidade1' )">+</button>
            ...
            <button type="button" class="btn btn-outline-dark btn-sm subtrair" onclick=menos(quantidade1)>-</button>
           
           <!-- <button type='button' class='btn btn-outline-dark btn-sm somar' onclick=mais(quantidade1)>+</button>
             <input class='form-control form-control-sm quantidadeIngredientes quantidade' type='number' 
             id='quantidade1' value=26>
             <button type='button' class='btn btn-outline-dark btn-sm subtrair' onclick=menos(quantidade1)>-</button>
            -->
        </td>
    </tr>
    ...
    <tr>
        <td>
            ...
            <button type="button" class="btn btn-outline-dark btn-sm somar"
                onclick="mais( 'quantidade4' )">+</button>

            <input class="form-control form-control-sm quantidadeIngredientes quantidade" type="number"
                id="quantidade4" value=0 name="quantidade4">

            <button type="button" class="btn btn-outline-dark btn-sm subtrair"
                onclick="menos( 'quantidade4' )">-</button>
        </td>
    </tr>
</table>
...
if (!empty($_POST['enviar'])) {
    ...
    for ($j = 0; $j < $i; $j++) {
        ...
        echo 'Item:'.$a[$j].'<br>'; 
        echo 'Quantidade:' . $_POST[$nomeVariavel[$j]].'<br><br>';
